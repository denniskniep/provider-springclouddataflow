# ====================================================================================
# Setup Project
PROJECT_NAME := provider-springclouddataflow
PROJECT_REPO := github.com/denniskniep/$(PROJECT_NAME)
...
IMAGES = provider-springclouddataflow
...
XPKGS = provider-springclouddataflow
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-springclouddataflow: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider SpringCloudDataFlow CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider SpringCloudDataFlow controllers
...
# This target prepares repo for your provider by replacing all "springclouddataflow"

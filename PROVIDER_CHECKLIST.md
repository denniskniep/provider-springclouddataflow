...
The [provider-springclouddataflow](https://github.com/denniskniep/provider-springclouddataflow) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-springclouddataflow](https://github.com/crossplane-contrib/provider-jet-springclouddataflow) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/denniskniep/provider-springclouddataflow/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/denniskniep/provider-springclouddataflow/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/denniskniep/provider-springclouddataflow/blob/main/hack/boilerplate.go.txt](https://github.com/denniskniep/provider-springclouddataflow/blob/main/hack/boilerplate.go.txt)
...
The [provider-springclouddataflow](https://github.com/denniskniep/provider-springclouddataflow)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/denniskniep/provider-springclouddataflow/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/denniskniep/provider-springclouddataflow/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue springclouddataflows (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/denniskniep/provider-springclouddataflow/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request SpringCloudDataFlows: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/denniskniep/provider-springclouddataflow/blob/master/.github/PULL_REQUEST_TEMPLATE.md))

...
The [provider-springclouddataflow](https://github.com/crossplane/provider-springclouddataflow) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-springclouddataflow/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-springclouddataflow/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-springclouddataflow/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-springclouddataflow/blob/main/hack/boilerplate.go.txt)
...
The [provider-springclouddataflow](https://github.com/crossplane/provider-springclouddataflow)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-springclouddataflow/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-springclouddataflow/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue springclouddataflows (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-springclouddataflow/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request SpringCloudDataFlows: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-springclouddataflow/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
